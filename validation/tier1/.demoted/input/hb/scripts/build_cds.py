...
Same GenBank records as build.py (zhu2018/hb_genbank.gb, MG772099-MG772439), same
...
RAW_GB = HERE / "zhu2018" / "hb_genbank.gb"
...
def main() -> None:
    ...
    for g in _GENES:
        aa_aligned = read_fasta(aln_dir / f"{g}.fasta")
        ...
        write_fasta(out_dir / f"{g}.fasta", codon_aln)
