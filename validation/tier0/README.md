...
| `asr_mode=compute` permulation null | **complete** — gate (D-T0-L) + compute-on-miss (fe5279b). Smoke: 9/15 genes contribute to the null (4 planted + 5 null-only), all 15 ASR-cached. |
