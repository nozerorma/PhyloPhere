...
quantile_cats <- categorize_species_by_quantile(cancer_traits_processed)
my_labels <- unique(pairwise_data$species2)
my_labels_colored <- create_colored_labels(my_labels, quantile_cats)
