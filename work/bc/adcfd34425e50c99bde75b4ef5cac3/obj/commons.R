...
source(file.path(workingDir, "./directories.R"))
source(file.path(workingDir, "./palettes.R"))
source(file.path(workingDir, "./stats.R"))
source(file = file.path(workingDir, "./fun.R"))
source(file.path(workingDir, "./io_utils.R"))
