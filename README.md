...
| `egg_members_file`, `egg_annotations_file` | `""` | Leave blank to auto-fetch the eggNOG5 Primates orthogroup pair (human subset), falling back to the vendored copy in `assets/eggnog/` if offline. |
