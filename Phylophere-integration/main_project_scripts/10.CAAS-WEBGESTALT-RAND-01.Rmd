...
# Load the gene_lists
geneList_dir <- file.path(resultsDir, "2.CAAS/4.5.Rand_results/GeneLists.01/malignant_prevalence")
...
geneList_dir <- file.path(resultsDir, "2.CAAS/4.5.Rand_results/GeneLists.01/neoplasia_prevalence")
geneList_files <- list.files(path = geneList_dir, pattern = "\\.txt$", full.names = TRUE, recursive = TRUE)
