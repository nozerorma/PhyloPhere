...
export CAAS_OUTBASE="/homes/users/mramon/scratch/2.Primates/2.Primates_results/CAAS_RESULTS/final"
export WORK_BASE="/homes/users/mramon/scratch/3.Work_dirs2"
