...
/*
#  ORA (WebGestalt) excluded-genes process wrapper
#  Mirrors ora_general.nf but publishes to ${params.outdir}/ora_excluded
#  so that excluded-gene enrichment results do not overwrite standard ORA outputs.
*/

process ORA_EXCLUDED_REPORT {
    tag "ora_excluded_general"
    label 'process_reporting'

    publishDir path: "${params.outdir}/ora_excluded", mode: 'copy', overwrite: true, pattern: '{ORA_files/**,ora_results/**,ora_summary/**,ora_plots/**}'
    ...
    def outdir       = "${params.outdir}/ora_excluded"
    def project_name = params.ora_project_name ?: 'ORA_Excluded_WebGestalt'
