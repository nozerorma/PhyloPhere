...
/*
#  STRING (rbioapi) enrichment accumulation-randomization process wrapper
#  Consumes gene_lists produced by CT_ACCUMULATION_RANDOMIZE
#  (published under accumulation/randomization/gene_lists/).
*/

process STRING_ACCUMULATION_REPORT {
    tag "string_accumulation"
    label 'process_reporting'

    publishDir path: "${params.outdir}/accumulation/string", mode: 'copy', overwrite: true, pattern: '{string_results/**,string_summary/**,string_plots/**}'
    ...
    def outdir                 = "${params.outdir}/accumulation/string"
    def project_name           = params.string_accumulation_project_name ?: 'STRING_Accumulation'
    ...
    if (params.use_singularity || params.use_apptainer) {
        ...
        /usr/local/bin/_entrypoint.sh Rscript -e "
            rmarkdown::render(
                ...
                output_file = 'STRING_accumulation.html'
            )
        "
        """
    } else {
