...
# guess a fixed safety margin (which is exactly what the `+ 0.10` below used
# to be: tuned to one dataset, wrong for the next), measure where the ring
# stack really ends, the same way fan_label_offsets() already does for the
# family-label ring, and only add whatever the taxa ring's nominal offset
