...
def extract_convergence_summary(
    ...
    summary: Dict[str, Any] = {
        ...
        "sig_hyp_fdr": result_dict.get("sig_hyp_fdr"),
        "sig_perm_fdr": result_dict.get("sig_perm_fdr"),
        "is_significant_fdr": result_dict.get("is_significant_fdr"),
        "pvalue_fdr": result_dict.get("pvalue_fdr"),
        "pvalue_boot_fdr": result_dict.get("pvalue_boot_fdr"),
        "alpha_fdr": result_dict.get("alpha_fdr"),
